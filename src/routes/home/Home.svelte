...
{#if data.testingHooks}
  <div class="banner">
    ...
    {#if data.cpus}
      <p>If Elder.js builds your site, it will span all {data.cpus.length} cpus listed below:</p>
      <ol>
...
<div class="banner">
  <h1>ajcwebdev</h1>
  <p>Woot! This blog was made with <a href="https://github.com/Elderjs/elderjs">Elder.js</a></p>
</div>
